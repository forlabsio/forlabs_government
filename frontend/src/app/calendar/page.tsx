...
import {
  ...
  MapPin, Clock, FileText, Plus, Check, X,
} from "lucide-react";
    ...
    <div style={{ display: "flex", height: "calc(100vh - 48px)" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", borderRight: `1px solid ${FOUNDRY.border}` }}>
        ...
        <div style={{
          ...
          <button onClick={prev} style={{ background: "transparent", border: "none", color: FOUNDRY.muted, cursor: "pointer", padding: 4 }}>
            <ChevronLeft size={18} />
          </button>
          <span style={{ fontSize: 16, fontWeight: 700, color: FOUNDRY.text, minWidth: 120, textAlign: "center" }}>
            {year}년 {month + 1}월
          </span>
          <button onClick={next} style={{ background: "transparent", border: "none", color: FOUNDRY.muted, cursor: "pointer", padding: 4 }}>
                ...
                .map(a => {
                  ...
                  return (
                    <div key={a.id} style={{
                      ...
                      {done && (
                        <span style={{ fontSize: 10, color: FOUNDRY.success, alignSelf: "center", flexShrink: 0 }}>✓</span>
                      )}
                    </div>
                  );
                })}
